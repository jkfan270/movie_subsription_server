	...
	if($no_of_row > 0)
	{
		...
		foreach($result as $row)
		{
			if($row['user_email_status'] == 'not verified')
			{
				...
				if(isset($sub_result))
				{
					$message = '<label class="text-success">Your Email Address Successfully Verified <br />You can login here - <a href="https://fanj.ursse.org/index.php">Login</a></label>';
				}
			}
			else
			{
...
<html>
	...
	<body>
		...
		<div class="container">
			<h1 align="center">Video Services Register Verification</h1>
